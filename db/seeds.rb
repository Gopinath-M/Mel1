...
agency3 = Agency.create(:name => 'Agency_three', :is_active => true)
agency4 = Agency.create(:name => 'Agency_four', :is_active => true)
...
unit_user1 = Unit.create(:department_id => 4, :name => 'UNIT KEWANGAN AGAMA', :is_active => 1)
...
unit_user1 = Unit.create(:department_id => 6, :name => 'U ONE D SIX KERJA RAYA TEMPATAN (KT)', :is_active => 1)
unit_user2 = Unit.create(:department_id => 6, :name => 'U TWO D SIX KERJA RAYA TEMPATAN (KT)', :is_active => 1)
unit_user3 = Unit.create(:department_id => 6, :name => 'U THREE D SIX KERJA RAYA TEMPATAN (KT)', :is_active => 1)
unit_user4 = Unit.create(:department_id => 6, :name => 'U FOUR D SIX KERJA RAYA TEMPATAN (KT)', :is_active => 1)

puts "Creating Sample Units for the department JABATAN MUFTI NEGERI MELAKA"
unit_user1 = Unit.create(:department_id => 8, :name => 'U ONE D EIGHT MUFTI NEGERI TEMPATAN (KT)', :is_active => 1)
unit_user2 = Unit.create(:department_id => 8, :name => 'U TWO D EIGHT MUFTI NEGERI TEMPATAN (KT)', :is_active => 1)
unit_user3 = Unit.create(:department_id => 8, :name => 'U THREE D EIGHT MUFTI NEGERI TEMPATAN (KT)', :is_active => 1)
unit_user4 = Unit.create(:department_id => 8, :name => 'U FOUR D EIGHT MUFTI NEGERI TEMPATAN (KT)', :is_active => 1)
...
department_admin2 = User.create(:ic_number => "123456784444", :email => 'sheikdawood.a@openwavecomp.in', :password => "password", :first_name => "DeptAdmin", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_admin3 = User.create(:ic_number => "123456786666", :email => 'sheikdawooda.a@openwavecomp.in', :password => "password", :first_name => "DeptAdmin", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_admin4 = User.create(:ic_number => "123456788888", :email => 'sheikdawoodb.a@openwavecomp.in', :password => "password", :first_name => "DeptAdmin", :last_name => "JMNM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_user5 = User.create(:ic_number => "123456781666", :email => 'owcsasitharan.t@openwavecomp.in', :password => "password", :first_name => "DeptUserFive", :last_name => "JKMM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_user6 = User.create(:ic_number => "123456781777", :email => 'owcnirmala.a.b@openwavecomp.in', :password => "password", :first_name => "DeptUserSix", :last_name => "JKMM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_user7 = User.create(:ic_number => "123456781888", :email => 'owcprakashkumar.m@openwavecomp.in', :password => "password", :first_name => "DeptUserSeven", :last_name => "JKMM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_user8 = User.create(:ic_number => "123456781999", :email => 'owcabuthahir.a.h@openwavecomp.in', :password => "password", :first_name => "DeptUserEight", :last_name => "JKMM", :status => 'A', :state => 7, :sign_in_count => 1)
...
department_user1 = User.create(:ic_number => "123456784111", :email => 'anusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserfirst", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user1.activate_user
...
department_user2 = User.create(:ic_number => "123456784222", :email => 'latha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSecond", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user2.activate_user
...
department_user3 = User.create(:ic_number => "123456784333", :email => 'sakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserThird", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user3.activate_user
...
department_user4 = User.create(:ic_number => "123456784555", :email => 'gopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserFour", :last_name => "JAIM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user4.activate_user
...
department_user5 = User.create(:ic_number => "123456784666", :email => 'owcanusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserFive", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user5.activate_user
...
department_user6 = User.create(:ic_number => "123456784777", :email => 'owclatha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSix", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user6.activate_user
...
department_user7 = User.create(:ic_number => "123456784888", :email => 'owcsakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserSeven", :last_name => "JAIM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user7.activate_user
...
department_user8 = User.create(:ic_number => "123456784999", :email => 'owcgopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserEight", :last_name => "JAIM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user8.activate_user
...
department_user1 = User.create(:ic_number => "123456786111", :email => 'owc2anusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserFirst", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user1.activate_user
...
department_user2 = User.create(:ic_number => "123456786222", :email => 'owc2latha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSecond", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user2.activate_user
...
department_user3 = User.create(:ic_number => "123456786333", :email => 'owc2sakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserThird", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user3.activate_user
rm_department_user3 = RoleMembership.create(:user_id => department_user3.id, :department_id => 6, :role_id => 4, :unit_id=>11, :status => 'A', :default_dept=>true)
department_user4 = User.create(:ic_number => "123456786444", :email => 'owc2gopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserFour", :last_name => "JKRM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user4.activate_user
...
department_user5 = User.create(:ic_number => "123456786555", :email => 'owc1anusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserFirst", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user5.activate_user
...
department_user6 = User.create(:ic_number => "123456786777", :email => 'owc1latha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSix", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user6.activate_user
...
department_user7 = User.create(:ic_number => "123456786888", :email => 'owc1sakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserSeven", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user7.activate_user
...
department_user8 = User.create(:ic_number => "123456786999", :email => 'owc1gopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserEight", :last_name => "JKRM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user8.activate_user
...
department_user1 = User.create(:ic_number => "123456788111", :email => 'owc_anusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserFirst", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user1.activate_user
...
department_user2 = User.create(:ic_number => "123456788222", :email => 'owc_latha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSecond", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user2.activate_user
...
department_user3 = User.create(:ic_number => "123456788333", :email => 'owc_sakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserThird", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user3.activate_user
...
department_user4 = User.create(:ic_number => "123456788444", :email => 'owc_gopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserFour", :last_name => "JKRM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user4.activate_user
...
department_user5 = User.create(:ic_number => "123456788555", :email => 'owc1_anusudha.r@openwavecomp.in', :password => "password", :first_name => "DeptUserFive", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user5.activate_user
...
department_user6 = User.create(:ic_number => "123456788666", :email => 'owc1_latha.k@openwavecomp.in', :password => "password", :first_name => "DeptUserSix", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user6.activate_user
...
department_user7 = User.create(:ic_number => "123456788777", :email => 'owc1_sakthivel.m@openwavecomp.in', :password => "password", :first_name => "DeptUserSeven", :last_name => "JKRM", :status => 'A', :state => 7, :sign_in_count => 1)
department_user7.activate_user
...
department_user8 = User.create(:ic_number => "123456788999", :email => 'owc1_gopinath.m@openwavecomp.in', :password => "password", :first_name => "DeptUserEight", :last_name => "JKRM", :status => 'A', :state => 15, :sign_in_count => 1)
department_user8.activate_user
