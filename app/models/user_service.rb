class UserService < ActiveRecord::Base
  ...
  attr_accessible :service_level_id,:classification_id,:grade_id,:service_standard_id,:appointment_id,:email,:position,:office_address,:office_number,:office_fax,:postal_code,:city,:state,:recent_salary,:user_id,:first_appointment_to_public_service,:first_appointment_to_present_position,:promotion_to_present_grade,:confirmation_date

  validates :service_level_id,:classification_id,:grade_id,:service_standard_id,:appointment_id,:email,:office_address,:office_number,:office_fax,:postal_code,:city,:state,:recent_salary,:first_appointment_to_public_service,:first_appointment_to_present_position, :presence => true
